...
C_A, C_T, C_S, C_R = symbols('C_A C_T C_S C_R')
...
# equilibrium values
A_eq, T_eq, S_eq ,R_eq = (700.0, 3000.0, 1000.0, 0)

state_vector = Matrix([C_A, C_T, C_S,C_R])
...
#F_AR=0
#F_AR=5.0
#F_AR=Piecewise((5.0, C_A>0),(0, True))
#F_AR=Piecewise((5,time_symbol>control_start_geo),(0,True))
F_AR=Piecewise((5,(time_symbol>control_start_geo)&( C_A>0)),(0,True))
#F_AR=Piecewise((0,time_symbol<control_start_geo),(5.0, ((C_A>0)&(time_symbol>=control_start_geo))),(0,True))
F_RA=0.001*C_R
input_fluxes = {0: u_A, 1: 0, 2: F_DS} 
output_fluxes = {2: F_SD}
net_input_fluxes = {0: u_A } 
net_output_fluxes = {2: assert_non_negative_sym(time_symbol,F_SD-F_DS)}
#net_output_fluxes = {2: F_SD-F_DS}
internal_fluxes = {
      (0,1): F_AT
     ,(0,2): F_AS
     ,(1,0): F_TA
...
start_values = 1.01*np.array([A_eq, T_eq, S_eq, R_eq])
...
times = np.linspace(start_year, end_year,10000)
