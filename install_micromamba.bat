...
call  micromamba install -y -c conda-forge matplotlib mpmath numpy plotly scipy sympy tqdm frozendict networkx pandas python-igraph pycairo pip
...
call  micromamba install -y -c conda-forge dask[distributed] jupyterlab jupytext nbformat nbmake notebook pytest zarr
...
# call  micromamba install -y -c conda-forge sphinx sphinx-autodoc-typehints
