...
call  micromamba install -y -c conda-forge --file requirements.test  --file requirements.non_src --file requirements.conda_extra
...
# call  micromamba install -y -c conda-forge --file requirements.doc 
...
call  pip install --no-deps -r requirements.github
...
call  pip install --no-deps -r pkg.github
