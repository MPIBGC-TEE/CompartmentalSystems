...
call micromamba install -y -c conda-forge --file requirements.test --file requirements.doc --file requirements.non_src --file requirements.conda_extra
...
call pip install git+https://github.com/MPIBGC-TEE/CompartmentalSystems.git#egg=CompartmentalSystems
