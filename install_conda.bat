...
call  conda install -y -c conda-forge --file requirements.test  --file requirements.non_src --file requirements.conda_extra
...
# call  conda install -y -c conda-forge --file requirements.doc 
