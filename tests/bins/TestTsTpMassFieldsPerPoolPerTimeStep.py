...
from CompartmentalSystems.bins.TsTpMassFieldsPerPoolPerTimeStep import (
    TsTpMassFieldsPerPoolPerTimeStep,
)
...
class TestTsTpMassFieldsPerPoolPerTimeStep(InDirTest):
    ...
    def test_mean_age_distribution_for_BW(self):
        ...
        age_dist_hist = TsTpMassFieldsPerPoolPerTimeStep.compute_from(
            initial_plains,
            external_inputs,
            internal_death_rate_functions,
            external_death_rate_functions,
            start,
            len(times) - 1,
        )
