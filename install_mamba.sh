...
# but is a known problem at the time of writing and does affect us.
 mamba install -y -c conda-forge matplotlib mpmath numpy plotly scipy sympy tqdm frozendict networkx pandas python-igraph pycairo pip
...
# you need some extra packages which can be installed by uncommenting the following line:
 mamba install -y -c conda-forge dask[distributed] jupyterlab jupytext nbformat nbmake notebook pytest zarr
...
#  mamba install -y -c conda-forge sphinx sphinx-autodoc-typehints
