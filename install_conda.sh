...
# but is a known problem at the time of writing and does affect us.
 conda install -y -c conda-forge --file requirements.test  --file requirements.non_src --file requirements.conda_extra
...
#  conda install -y -c conda-forge --file requirements.doc 
